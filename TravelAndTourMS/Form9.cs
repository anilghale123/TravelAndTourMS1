      ...
      */
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "INSERT INTO TBook (PhoneNum,TravelDate,Activities,Transportation,Place,Naam,Addresses,NTraveller) VALUES (@phoneNum, @travelDate, @activities, @transportation, @place, @name, @address, @numTravelers)";
