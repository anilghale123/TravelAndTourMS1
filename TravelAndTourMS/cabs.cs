...
{
    public partial class cabs : Form
    {
        ...
        private void cabs_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void LoadData()
        {
            ...
            using (SqlConnection connection = new SqlConnection(con.ConnectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT * FROM cab", connection))
                {
        ...
        private void pictureBox_Click(object sender, EventArgs e)
        {
            ...
            cabdescription form2 = new cabdescription(id);
